...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().Map(m => m.ToTable("products", "gadgetsonline_dbo"));
            ...
            modelBuilder.Entity<Category>().Map(m => m.ToTable("categories", "gadgetsonline_dbo"));
            ...
            modelBuilder.Entity<Cart>().Map(m => m.ToTable("carts", "gadgetsonline_dbo"));
            ...
            modelBuilder.Entity<Order>().Map(m => m.ToTable("orders", "gadgetsonline_dbo"));
            ...
            modelBuilder.Entity<OrderDetail>().Map(m => m.ToTable("orderdetails", "gadgetsonline_dbo"));
