...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------
        // DateTime UTC fix for Npgsql — ensures all DateTime values sent to
        // PostgreSQL are marked as UTC, preventing
        // "Cannot write DateTime with Kind=Local" exceptions.
        // ---------------------------------------------------------------------
