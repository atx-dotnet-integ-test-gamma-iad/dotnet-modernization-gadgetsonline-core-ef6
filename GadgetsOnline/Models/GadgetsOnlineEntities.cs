...
namespace GadgetsOnline.Models
{
    ...
    // Registers NpgsqlServices and NpgsqlConnectionFactory so that EF6 routes
    // all database operations through the Npgsql ADO.NET driver.
    // -------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------
        // EF6 DateTime UTC fix: PostgreSQL requires DateTimeKind.Utc for
        // timestamp columns. Override SaveChanges / SaveChangesAsync to
        // normalise all DateTime values before they are sent to the database.
        // ---------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // All five entities live in the "gadgetsonline_dbo" schema on the
            // target PostgreSQL server.  Table names and column names are all
            // lower-case as produced by the schema-migration tooling.
            // -----------------------------------------------------------------
