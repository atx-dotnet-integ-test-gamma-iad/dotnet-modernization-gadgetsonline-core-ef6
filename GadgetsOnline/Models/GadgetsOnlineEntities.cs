...
{
    /// <summary>
    /// PostgreSQL DbConfiguration for Npgsql EF6 provider.
    /// Registers NpgsqlServices and NpgsqlConnectionFactory so that
    /// EntityFramework routes all database operations through Npgsql
    /// instead of the SQL Server provider.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------
        // DateTime compatibility: coerce all DateTime values to UTC
        // before persisting so Npgsql's timestamptz columns accept them.
        // ---------------------------------------------------------------
