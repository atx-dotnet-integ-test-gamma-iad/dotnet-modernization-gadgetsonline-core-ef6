...
namespace GadgetsOnline.Models
{
    ...
    /// EntityFramework6.Npgsql is used instead of the SQL Server provider.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // DateTime UTC fix: EF6 + Npgsql requires all DateTime values to have
        // DateTimeKind.Utc before they are persisted to PostgreSQL.
        // ---------------------------------------------------------------------------
