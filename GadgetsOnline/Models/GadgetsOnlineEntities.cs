...
namespace GadgetsOnline.Models
{
    ...
    // Entity Framework 6 routes all database work through Npgsql instead of
    // the default SQL Server provider.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // PostgreSQL requires all timestamp values to carry explicit UTC kind.
        // These overrides normalise any Unspecified/Local DateTime values to UTC
        // before they are sent to the database, preventing runtime exceptions.
        // ---------------------------------------------------------------------------
