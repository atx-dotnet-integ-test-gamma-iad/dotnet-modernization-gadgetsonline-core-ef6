...
namespace GadgetsOnline.Models
{
    ...
    /// EF6 uses PostgreSQL instead of SQL Server at runtime.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -------------------------------------------------------------------------
        // DateTime compatibility: Npgsql requires DateTime values stored in
        // PostgreSQL timestamp columns to carry DateTimeKind.Utc.  The helpers
        // below normalise every DateTime on the change-tracker before EF6 sends
        // INSERT / UPDATE statements to the database.
        // -------------------------------------------------------------------------
        ...
        {
            // -----------------------------------------------------------------
            // Table + column name mappings (MSSQL dbo -> PostgreSQL gadgetsonline_dbo)
            // Source of truth: schema mapping tool results.
            // -----------------------------------------------------------------
            ...
            // -- Cart ---------------------------------------------------------
            {
                ...
                // Relationship: each Cart line requires one Product
            ...
            // -- Order --------------------------------------------------------
            {
                ...
                // Relationship: one Order -> many OrderDetails
            ...
            // -- OrderDetail --------------------------------------------------
            {
                ...
                // Relationship: each OrderDetail requires one Product
