...
namespace GadgetsOnline.Models
{
    ...
    /// Required by EntityFramework6.Npgsql to register the Npgsql provider services
    /// and connection factory with Entity Framework's DbConfiguration infrastructure.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // Ensures all DateTime values are marked as UTC before persisting,
        // which is required by Npgsql's strict DateTimeKind handling.
        // -------------------------------------------------------------------------
