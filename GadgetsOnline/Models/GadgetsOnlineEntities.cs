...
namespace GadgetsOnline.Models
{
    ...
    /// so that EF6 can resolve the correct ADO.NET driver at runtime.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // DateTime UTC fix: Npgsql requires all DateTime values stored as TIMESTAMPTZ
        // to have DateTimeKind.Utc. These overrides normalise any Local/Unspecified
        // values to Utc before they reach the database driver.
        // ---------------------------------------------------------------------------
