...
{
    /// <summary>
    /// PostgreSQL DbConfiguration for GadgetsOnlineEntities.
    /// Registers the Npgsql provider services and connection factory
    /// so that EF6 resolves the correct driver at runtime.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        {
            // ----------------------------------------------------------------
            // Table + column mappings (gadgetsonline_dbo schema, PostgreSQL)
            // ----------------------------------------------------------------
