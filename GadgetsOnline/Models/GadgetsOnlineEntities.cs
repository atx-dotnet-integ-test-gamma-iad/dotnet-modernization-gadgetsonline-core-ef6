...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------
        // EF6 DateTime UTC fix: Npgsql requires DateTimeKind.Utc for
        // timestamp columns. Normalize all DateTime values before saving.
        // ---------------------------------------------------------------
        ...
        {
            // ---------------------------------------------------------------
            // Table and column name mappings (PostgreSQL: schema gadgetsonline_dbo,
            // all table/column names lowercased per PostgreSQL convention)
            // ---------------------------------------------------------------
