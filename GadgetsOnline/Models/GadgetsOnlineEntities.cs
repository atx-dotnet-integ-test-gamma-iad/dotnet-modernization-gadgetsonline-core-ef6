...
namespace GadgetsOnline.Models
{
    ...
    // Required by EntityFramework6.Npgsql 6.4.x — registered once per AppDomain
    // -----------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // Npgsql requires all DateTime values stored as timestamptz to be UTC.
        // These overrides normalise the Kind before every save operation.
        // --------------------------------------------------------------------
        ...
        {
            // ----------------------------------------------------------------
            // Category — table + column mappings then relationships
            // ----------------------------------------------------------------
            ...
            // ----------------------------------------------------------------
            // Cart — table + column mappings then relationships
            // ----------------------------------------------------------------
            ...
            // ----------------------------------------------------------------
            // Order — table + column mappings then relationships
            // ----------------------------------------------------------------
            ...
            // ----------------------------------------------------------------
            // OrderDetail — table + column mappings then relationships
            // ----------------------------------------------------------------
