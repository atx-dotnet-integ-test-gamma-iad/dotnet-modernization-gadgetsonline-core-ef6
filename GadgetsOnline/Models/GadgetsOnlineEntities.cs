...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // Npgsql rejects DateTime values whose Kind is not DateTimeKind.Utc when
        // writing to a 'timestamp with time zone' column.  These overrides normalise
        // every tracked DateTime to Utc before hitting the database.
        // ---------------------------------------------------------------------------
        ...
        {
            // -----------------------------------------------------------------------
            // Table and column name mappings — target schema: gadgetsonline_dbo
            ...
            // -----------------------------------------------------------------------
            // Relationship configurations — preserved exactly from original file
            // -----------------------------------------------------------------------
