...
namespace GadgetsOnline.Models
{
    ...
    // EF6 knows how to talk to PostgreSQL without any app.config provider entry.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // PostgreSQL requires all timestamp values to carry UTC kind.
        // These overrides normalise every DateTime on the change-tracker before
        // the values are sent to the database.
        // -----------------------------------------------------------------------
