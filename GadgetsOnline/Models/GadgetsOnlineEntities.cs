...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // EF6 DateTime UTC fix: ensures all DateTime values sent to PostgreSQL carry
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Category relationships (preserved unchanged)
            modelBuilder.Entity<Category>()
            ...
            // Cart relationships (preserved unchanged)
            modelBuilder.Entity<Cart>()
            ...
            // Order relationships (preserved unchanged)
            modelBuilder.Entity<Order>()
            ...
            // OrderDetail relationships (preserved unchanged)
            modelBuilder.Entity<OrderDetail>()
