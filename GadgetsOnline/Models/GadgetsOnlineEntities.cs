...
namespace GadgetsOnline.Models
{
    ...
    // Registered via the [DbConfigurationType] attribute on GadgetsOnlineEntities.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // Npgsql requires all DateTime values stored as timestamptz to have
        // DateTimeKind.Utc; this override normalises them on every save.
        // ---------------------------------------------------------------------------
