...
namespace GadgetsOnline.Models
{
    ...
    // routes all database operations through Npgsql instead of SQL Server.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // DateTime UTC compatibility: normalises all DateTime values to UTC before
        // they are sent to PostgreSQL, which requires timestamptz to carry UTC kind.
        // ---------------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Column names are the exact PostgreSQL lowercase identifiers produced
            // by the schema-mapping tool.
            // -----------------------------------------------------------------------
