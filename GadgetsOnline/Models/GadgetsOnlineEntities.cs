...
namespace GadgetsOnline.Models
{
    ...
    // uses PostgreSQL instead of SQL Server for this context.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ------------------------------------------------------------------
        // DateTime UTC fix: Npgsql requires all DateTime values stored as
        // timestamptz to carry DateTimeKind.Utc.  These overrides normalise
        // any Unspecified/Local values before they reach the database.
        // ------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Schema: gadgetsonline_dbo  (target PostgreSQL schema)
            // Column names are lowercased to match the migrated PostgreSQL DDL.
            // ----------------------------------------------------------------
