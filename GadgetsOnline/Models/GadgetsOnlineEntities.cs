...
{
    /// <summary>
    /// EF6 PostgreSQL (Npgsql) configuration class.
    /// Registers the Npgsql provider services and connection factory so that
    /// EF6 knows how to talk to PostgreSQL via the Npgsql ADO.NET driver.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // The connection string named "GadgetsOnlineEntities" in Web.config /
        // App.config must use providerName="Npgsql" and a valid PostgreSQL
        // connection string (e.g. Host=...;Database=...;Username=...;Password=...).
        ...
        // database to carry DateTimeKind.Utc. These overrides normalise all
        // DateTime / DateTime? values to Utc before every save so that no
        // "Cannot write DateTime with Kind=Local/Unspecified" exceptions are thrown.
        // ---------------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // All table / column names are lower-case as created by the migration.
            // -----------------------------------------------------------------
            ...
            // -----------------------------------------------------------------
            // Relationship / FK configurations (preserved unchanged)
            // -----------------------------------------------------------------
