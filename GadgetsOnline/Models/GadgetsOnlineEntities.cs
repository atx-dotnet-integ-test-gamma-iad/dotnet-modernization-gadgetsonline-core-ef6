...
namespace GadgetsOnline.Models
{
    ...
    // EntityFramework 6 routes all database calls through the PostgreSQL driver.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------------
        // DateTime UTC fix for Npgsql — must be called before every write so that
        // all DateTime values are stored as UTC (Npgsql rejects Unspecified kind).
        // -----------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Generated from core_get_entities_for_fluent_api_by_dbcontext tool.
            // ===================================================================
            ...
            // Existing relationship — preserved unchanged
