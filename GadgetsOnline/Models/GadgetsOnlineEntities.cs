...
namespace GadgetsOnline.Models
{
    ...
    // Required so that EF6 resolves the Npgsql provider services and connection
    // factory without relying on machine-wide provider registration.
    // -------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // FixDateTimeKinds() normalises every DateTime being written so that
        // Npgsql does not throw "Cannot write DateTime with Kind=Unspecified".
        // ---------------------------------------------------------------------
        ...
        {
            // -----------------------------------------------------------------
            // Table + column name mappings — target schema: gadgetsonline_dbo
            // Generated from Fluent API schema mapping tool results.
            // -----------------------------------------------------------------
            ...
            // -----------------------------------------------------------------
            // Relationships — preserved exactly as originally configured
            // -----------------------------------------------------------------
