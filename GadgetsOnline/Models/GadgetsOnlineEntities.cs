...
{
    /// <summary>
    /// EF6 Npgsql provider configuration for GadgetsOnlineEntities.
    /// Registers the Npgsql provider services and connection factory so that
    /// EF6 uses PostgreSQL instead of SQL Server.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // DateTime UTC compatibility for PostgreSQL (Npgsql strict timestamp handling)
        // ---------------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Preserve existing relationship: Category has many Products
            ...
            // Preserve existing relationship: Cart requires one Product
            ...
            // Preserve existing relationship: Order has many OrderDetails
            ...
            // Preserve existing relationship: OrderDetail requires one Product
