...
{
    /// <summary>
    /// EF6 PostgreSQL DbConfiguration for Npgsql provider registration.
    /// Registers Npgsql as the database provider and sets the default connection factory.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        {
            // ---------------------------------------------------------------
            // Schema + column name mappings for PostgreSQL (gadgetsonline_dbo)
            // ---------------------------------------------------------------
