...
namespace GadgetsOnline.Models
{
    ...
    // Routes Npgsql as the ADO.NET provider for this DbContext.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // Npgsql requires DateTime values to carry DateTimeKind.Utc on timestamptz
        // columns.  These overrides normalise any Unspecified/Local values before
        // they reach the driver so existing code needs no changes at the call site.
        // ---------------------------------------------------------------------------
        ...
        {
            // -----------------------------------------------------------------------
            // Table + column name mappings (PostgreSQL target schema: gadgetsonline_dbo)
            // Generated from core_get_entities_for_fluent_api_by_dbcontext /
            // core_get_schema_mappings_by_file tool results.
            // -----------------------------------------------------------------------
            ...
            // Category -> gadgetsonline_dbo.categories
            {
                ...
                // Relationship: Category -> Products (one-to-many)
            ...
            // Cart -> gadgetsonline_dbo.carts
            {
                ...
                // Relationship: Cart -> Product (many-to-one)
            ...
            // Order -> gadgetsonline_dbo.orders
            {
                ...
                // Relationship: Order -> OrderDetails (one-to-many)
            ...
            // OrderDetail -> gadgetsonline_dbo.orderdetails
            {
                ...
                // Relationship: OrderDetail -> Product (many-to-one)
