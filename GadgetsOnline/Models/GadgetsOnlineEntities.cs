...
namespace GadgetsOnline.Models
{
    ...
    /// EF6 routes all database operations through the Npgsql driver.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // Npgsql requires DateTime values to carry DateTimeKind.Utc when writing to
        // timestamptz columns.  These overrides normalise all tracked DateTime values
