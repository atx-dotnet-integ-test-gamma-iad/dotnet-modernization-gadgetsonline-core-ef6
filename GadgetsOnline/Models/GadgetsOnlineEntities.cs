...
{
    // ---------------------------------------------------------------------------
    // PostgreSQL / Npgsql provider registration for EF6
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------------
        // EF6 DateTime UTC fix — normalises all DateTime values to UTC
        // before they are written to PostgreSQL (timestamptz columns).
        // -----------------------------------------------------------------------
        ...
        {
            // -------------------------------------------------------------------
            // Table → PostgreSQL schema + table name mappings
            // Schema: gadgetsonline_dbo   (authoritative from schema-mapping tool)
            // -------------------------------------------------------------------
