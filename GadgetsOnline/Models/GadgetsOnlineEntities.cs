...
namespace GadgetsOnline.Models
{
    ...
    // Replaces the SQL Server provider registration previously held in app.config.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------------
        // DateTime UTC fix: ensures DateTime values are sent to PostgreSQL with
        // Kind = Utc, which Npgsql requires for timestamptz columns.
        // -----------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Preserve original relationship: Category → Products
            modelBuilder.Entity<Category>()
            ...
            // Preserve original relationship: Cart → Product
            modelBuilder.Entity<Cart>()
            ...
            // Preserve original relationship: Order → OrderDetails
            modelBuilder.Entity<Order>()
            ...
            // Preserve original relationship: OrderDetail → Product
            modelBuilder.Entity<OrderDetail>()
