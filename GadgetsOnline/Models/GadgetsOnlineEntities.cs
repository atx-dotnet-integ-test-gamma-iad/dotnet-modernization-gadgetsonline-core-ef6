...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // DateTime compatibility: normalise all DateTime values to UTC before persist
        // ---------------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Preserve existing relationship: Cart requires Product
            ...
            // Preserve existing relationship: OrderDetail requires Product
