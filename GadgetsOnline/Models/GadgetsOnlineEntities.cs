...
namespace GadgetsOnline.Models
{
    ...
    // routes all database access through Npgsql instead of SQL Server.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // Npgsql requires all DateTime values written to timestamptz columns to have
        // DateTimeKind.Utc.  These overrides normalise all DateTime values to Utc
