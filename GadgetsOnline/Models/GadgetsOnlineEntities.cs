...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // DateTime UTC compatibility for PostgreSQL: Npgsql requires all DateTime
        // values to have DateTimeKind.Utc. These overrides normalise any Unspecified
        // or Local values before they are sent to the database.
        // ---------------------------------------------------------------------------
