...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Product entity configuration (EF6 fluent API style)
            ...
            // Category entity configuration (EF6 fluent API style)
            ...
            // Cart entity configuration (EF6 fluent API style)
            ...
            // Order entity configuration (EF6 fluent API style)
            ...
            // OrderDetail entity configuration (EF6 fluent API style)
