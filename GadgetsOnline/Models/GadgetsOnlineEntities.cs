...
namespace GadgetsOnline.Models
{
    ...
    // resolves the correct ADO.NET driver when the application starts up.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------------
        // DateTime UTC fix: Npgsql requires all DateTime values sent to PostgreSQL
        // to carry DateTimeKind.Utc. These overrides normalise any Unspecified or
        // Local timestamps before they reach the database driver.
        // -----------------------------------------------------------------------
