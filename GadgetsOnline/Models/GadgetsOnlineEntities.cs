...
namespace GadgetsOnline.Models
{
    ...
    // Requires packages: EntityFramework6.Npgsql 6.4.3 + Npgsql 5.0.18
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------------
        // DateTime compatibility: Npgsql 6+ requires DateTimeKind.Utc for
        // timestamp columns. Normalize all Added/Modified DateTime values here.
        // -----------------------------------------------------------------------
        ...
        {
            // -----------------------------------------------------------------------
            // PostgreSQL schema + table/column mappings
            // Source schema: dbo  →  Target schema: gadgetsonline_dbo
            // -----------------------------------------------------------------------
            ...
            // Category → categories (relationship preserved below)
            ...
            // Cart → carts (relationship preserved below)
            ...
            // Order → orders (relationship preserved below)
            ...
            // OrderDetail → orderdetails (relationship preserved below)
            ...
            // -----------------------------------------------------------------------
            // Relationship configuration (unchanged from original)
            // -----------------------------------------------------------------------
            modelBuilder.Entity<Category>()
