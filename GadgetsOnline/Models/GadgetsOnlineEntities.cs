...
namespace GadgetsOnline.Models
{
    ...
    /// so that EntityFramework6.Npgsql is used instead of SQL Server.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // DateTime compatibility for PostgreSQL / Npgsql EF6.
        // Npgsql requires all DateTime values passed to the database to carry
        // DateTimeKind.Utc.  These overrides normalise every Added/Modified
        // DateTime before the underlying SaveChanges reaches the provider.
        // ---------------------------------------------------------------------------
