...
{
    /// <summary>
    /// EF6 PostgreSQL DbConfiguration — registers Npgsql as the provider
    /// and sets the default connection factory for all GadgetsOnlineEntities contexts.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // PostgreSQL are treated as UTC (Npgsql requirement).
        // ---------------------------------------------------------------
