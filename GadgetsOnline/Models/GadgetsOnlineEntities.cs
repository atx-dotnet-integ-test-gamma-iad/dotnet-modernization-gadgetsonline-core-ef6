...
namespace GadgetsOnline.Models
{
    ...
    // Entity Framework 6 routes all database operations through Npgsql.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // SaveChanges overrides — ensure all DateTime values are stored as UTC so
        // that Npgsql does not raise "Cannot write DateTime with Kind=Local" errors.
        // ---------------------------------------------------------------------------
