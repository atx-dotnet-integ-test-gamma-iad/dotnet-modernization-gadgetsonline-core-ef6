...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // PostgreSQL requires DateTime values to have DateTimeKind.Utc.
        // These overrides ensure all Added/Modified DateTime values are treated
        // as UTC before they are sent to the database.
        // ---------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // All entity names, table names, and column names use the exact
            // values returned by the schema-mapping tool.
            // -----------------------------------------------------------------
