...
namespace GadgetsOnline.Models
{
    ...
    // EF6 can resolve a PostgreSQL connection from the named connection string
    // "GadgetsOnlineEntities" stored in App/Web.config.
    // -------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------
        // DateTime UTC normalisation — required for Npgsql timestamp handling
        // -----------------------------------------------------------------
