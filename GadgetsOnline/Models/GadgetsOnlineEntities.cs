...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // DateTime UTC compatibility: Npgsql requires DateTime values stored in
        // timestamptz columns to carry DateTimeKind.Utc. These overrides normalise
        // all Added/Modified DateTime properties to Utc before hitting the database.
        // ---------------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Source of truth: core_get_entities_for_fluent_api_by_dbcontext tool.
            // -----------------------------------------------------------------------
