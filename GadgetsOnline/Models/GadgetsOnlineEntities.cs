...
{
    // PostgreSQL-specific DbConfiguration for EF6
    public class GadgetsOnlineEntitiesPostgreSqlConfiguration : DbConfiguration
    {
        public GadgetsOnlineEntitiesPostgreSqlConfiguration()
        {
            ...
            // No explicit configuration needed for Npgsql 5.x with EF6.Npgsql 6.5.1
        }
    }
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // EF6 DateTime fix for PostgreSQL - SaveChanges override
        ...
        // EF6 DateTime fix for PostgreSQL - SaveChangesAsync override
        ...
        // Helper method to ensure all DateTime values are UTC for PostgreSQL
