...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // Npgsql rejects DateTime values whose Kind is not DateTimeKind.Utc.
        // These overrides normalise every DateTime to UTC before persisting.
        // -----------------------------------------------------------------------
        ...
        {
            // -------------------------------------------------------------------
            // Schema + column name mappings  (target schema: gadgetsonline_dbo)
            // -------------------------------------------------------------------
