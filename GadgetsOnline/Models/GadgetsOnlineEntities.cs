...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        {
            // ---------------------------------------------------------------
            // Table and column mappings: dbo (SQL Server) -> gadgetsonline_dbo (PostgreSQL)
            // ---------------------------------------------------------------
        ...
        // DateTime properties on Added/Modified entities before the base
        // SaveChanges call hits the database.
        // -----------------------------------------------------------------------
