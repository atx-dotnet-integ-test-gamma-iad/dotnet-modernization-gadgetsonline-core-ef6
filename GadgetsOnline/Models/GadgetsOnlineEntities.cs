...
{
    /// <summary>
    /// EF6 DbConfiguration class for PostgreSQL/Npgsql provider.
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // -------------------------------------------------------------------------
            // Category entity: table + column mappings, and relationship to Products
            // -------------------------------------------------------------------------
            ...
            // -------------------------------------------------------------------------
            // Cart entity: table + column mappings, and relationship to Product
            // -------------------------------------------------------------------------
            ...
            // -------------------------------------------------------------------------
            // Order entity: table + column mappings, and relationship to OrderDetails
            // -------------------------------------------------------------------------
            ...
            // -------------------------------------------------------------------------
            // OrderDetail entity: table + column mappings, and relationship to Product
            // -------------------------------------------------------------------------
        ...
        // Ensures all DateTime values are stored with UTC kind to avoid Npgsql errors.
        // -------------------------------------------------------------------------
