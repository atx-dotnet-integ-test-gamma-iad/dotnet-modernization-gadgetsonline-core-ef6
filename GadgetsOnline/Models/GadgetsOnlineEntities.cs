...
{
    /// <summary>
    /// EF6 DbConfiguration for the Npgsql (PostgreSQL) provider.
    /// Registers NpgsqlServices and NpgsqlConnectionFactory so EF6 routes
    /// all database operations through Npgsql instead of SQL Server.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // DateTime UTC compatibility: normalise all DateTime values to UTC kind
        // before persisting so Npgsql does not throw on "timestamptz" columns.
        // ---------------------------------------------------------------------------
