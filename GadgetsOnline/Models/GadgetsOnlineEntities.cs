...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------
        // SaveChanges overrides — fix DateTime kinds for PostgreSQL (UTC)
        // -----------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // ---- Category (+ relationship: Category → Products) --------
            ...
            // ---- Cart (+ relationship: Cart → Product) -----------------
            ...
            // ---- Order (+ relationship: Order → OrderDetails) ----------
            ...
            // ---- OrderDetail (+ relationship: OrderDetail → Product) ---
