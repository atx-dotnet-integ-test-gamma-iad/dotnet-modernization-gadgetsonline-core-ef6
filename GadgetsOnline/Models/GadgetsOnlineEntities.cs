...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        {
            // ---------------------------------------------------------------
            // Table and column name mappings for PostgreSQL (gadgetsonline_dbo)
            // ---------------------------------------------------------------
        ...
        // -------------------------------------------------------------------
        // DateTime UTC fix: ensures DateTime values are stored as UTC in
        // PostgreSQL, which is strict about timestamp kinds.
        // -------------------------------------------------------------------
