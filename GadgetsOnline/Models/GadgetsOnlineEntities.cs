...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------------
        // DateTime compatibility: Npgsql requires UTC DateTimeKind for timestamp
        // columns. These overrides normalise all DateTime values before they are
        // sent to PostgreSQL so that existing code that writes unspecified/local
        // DateTimes (e.g. Cart.DateCreated, Order.OrderDate) continues to work.
        // -----------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Relationship: Category (1) ──< Product (many)
            modelBuilder.Entity<Category>()
            ...
            // Relationship: Order (1) ──< OrderDetail (many)
            modelBuilder.Entity<Order>()
            ...
            // Relationship: OrderDetail (*) ──> Product (1)
            modelBuilder.Entity<OrderDetail>()
