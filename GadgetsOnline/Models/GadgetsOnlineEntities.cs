...
namespace GadgetsOnline.Models
{
    ...
    // EF6 can resolve the correct provider services at runtime without requiring
    // an entry in App.config / Web.config.
    // -------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -------------------------------------------------------------------------
        // DateTime UTC compatibility shim for Npgsql EF6.
        // Npgsql requires DateTime values to carry DateTimeKind.Utc when writing
        // to "timestamp with time zone" columns.  These overrides normalise all
        // Added/Modified DateTime values before they reach the database.
        // -------------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // All 5 entities / 31 properties are mapped to their PostgreSQL
            // lowercase equivalents in the gadgetsonline_dbo schema.
            // -----------------------------------------------------------------
            ...
            // Category
            {
                ...
                // Preserved relationship: Category -> Products
            ...
            // Cart
            {
                ...
                // Preserved relationship: Cart -> Product
            ...
            // Order
            {
                ...
                // Preserved relationship: Order -> OrderDetails
            ...
            // OrderDetail
            {
                ...
                // Preserved relationship: OrderDetail -> Product
