...
namespace GadgetsOnline.Models
{
    ...
    // knows to use Npgsql instead of the default SQL Server provider.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------------
        // DateTime UTC fix: Npgsql requires all DateTime values to have
        // DateTimeKind.Utc when writing to timestamptz columns.
        // -----------------------------------------------------------------------
