...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // DateTime UTC fix — EF6 / Npgsql requires DateTimeKind.Utc on all DateTime
        // values written to timestamptz columns.
        // ---------------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // ------------------------------------------------------------------
            {
                ...
                // Relationship: Category -> Products (preserved)
            ...
            // ------------------------------------------------------------------
            {
                ...
                // Relationship: Cart -> Product (preserved)
            ...
            // ------------------------------------------------------------------
            {
                ...
                // Relationship: Order -> OrderDetails (preserved)
            ...
            // ------------------------------------------------------------------
            {
                ...
                // Relationship: OrderDetail -> Product (preserved)
