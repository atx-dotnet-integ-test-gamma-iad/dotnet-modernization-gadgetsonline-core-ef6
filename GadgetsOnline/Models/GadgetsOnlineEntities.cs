...
{
    // -------------------------------------------------------------------------
    // EF6 PostgreSQL provider configuration class.
    // Replaces SQL Server provider services and connection factory with Npgsql
    // equivalents so that EF6 uses PostgreSQL for all database operations.
    // -------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // writing to timestamptz columns.  These overrides normalise every
        // Added/Modified DateTime value before hitting the database.
        // -----------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // All table names and column names are lowercase per PostgreSQL
            // naming conventions.  These mappings were generated from the
            // schema mapping tool and must remain in sync with the migrations.
            // -----------------------------------------------------------------
