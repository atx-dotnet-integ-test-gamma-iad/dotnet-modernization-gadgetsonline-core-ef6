...
namespace GadgetsOnline.Models
{
    ...
    // that EF6 uses PostgreSQL instead of SQL Server at runtime.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------------
        // DateTime UTC fix: ensures all DateTime values are stored as UTC so that
        // Npgsql does not throw "Cannot write DateTime with Kind=Local" exceptions.
        // -----------------------------------------------------------------------
