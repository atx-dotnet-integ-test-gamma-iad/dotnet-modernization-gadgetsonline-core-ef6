...
namespace GadgetsOnline.Models
{
    ...
    // EF6 uses PostgreSQL instead of SQL Server for this DbContext.
    // -------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // Npgsql requires DateTime values to have DateTimeKind.Utc when writing
        // to timestamptz columns.  FixDateTimeKinds() normalises all tracked
        // DateTime values to Utc before each save operation.
        // ---------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Source-of-truth values supplied by core_get_schema_mappings_by_file
            // and core_get_entities_for_fluent_api_by_dbcontext.
            // -----------------------------------------------------------------
