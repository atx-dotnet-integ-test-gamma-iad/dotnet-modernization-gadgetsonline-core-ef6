...
{
    // EF6 PostgreSQL provider configuration — replaces app.config provider registration
    // and is the preferred approach for .NET 8 hosted EF6 applications.
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // DateTime compatibility: Npgsql requires UTC DateTimeKind on all DateTime
        // values. These overrides normalise any Unspecified/Local values before save.
        // ---------------------------------------------------------------------------
