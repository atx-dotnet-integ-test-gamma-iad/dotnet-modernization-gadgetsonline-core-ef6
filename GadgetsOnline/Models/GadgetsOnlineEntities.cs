...
namespace GadgetsOnline.Models
{
    ...
    // Required by EntityFramework6.Npgsql to register the Npgsql provider
    // -----------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------------
        // DateTime compatibility: PostgreSQL requires UTC DateTimeKind on all
        // DateTime values. These overrides normalise any unspecified DateTimes
        // to UTC before EF6 sends them to Npgsql.
        // -----------------------------------------------------------------------
