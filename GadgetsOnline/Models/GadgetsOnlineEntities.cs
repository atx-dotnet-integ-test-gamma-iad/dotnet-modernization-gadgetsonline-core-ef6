...
namespace GadgetsOnline.Models
{
    ...
    // Registered via [DbConfigurationType] on GadgetsOnlineEntities so that EF6
    // picks up the correct provider services and connection factory automatically.
    // -------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------
        // DateTime UTC compatibility for Npgsql / PostgreSQL.
        // Npgsql requires that all DateTime values sent to the database carry
        // DateTimeKind.Utc.  These overrides normalise any Local/Unspecified
        // values before they are handed to the provider.
        // -----------------------------------------------------------------
