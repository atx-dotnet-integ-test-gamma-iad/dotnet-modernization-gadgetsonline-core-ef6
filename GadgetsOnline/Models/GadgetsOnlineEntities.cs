...
namespace GadgetsOnline.Models
{
    ...
    // Replaces SQL Server provider with Npgsql for PostgreSQL connectivity.
    // -------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------
        // DateTime UTC fix: ensures DateTime values are treated as UTC when
        // persisting to PostgreSQL (which requires timezone-aware timestamps).
        // ---------------------------------------------------------------------
