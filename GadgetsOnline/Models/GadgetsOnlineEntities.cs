...
namespace GadgetsOnline.Models
{
    ...
    // all database calls through the Npgsql ADO.NET driver instead of SqlClient.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // columns to carry DateTimeKind.Utc.  The helpers below normalise any
        // Added/Modified entity before the underlying SaveChanges call.
        // -----------------------------------------------------------------------
