...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // -----------------------------------------------------------------
            // Relationships and constraints (preserved from original)
            // -----------------------------------------------------------------
        ...
        // -----------------------------------------------------------------
        // DateTime UTC fix: ensures all DateTime values written to PostgreSQL
        // are treated as UTC (Npgsql requires DateTimeKind.Utc for timestamptz).
        // -----------------------------------------------------------------
