...
{
    // PostgreSQL DbConfiguration for EF6 + EntityFramework6.Npgsql
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        {
            // --- PostgreSQL: Product -> products (schema: gadgetsonline_dbo) ---
            ...
            // --- PostgreSQL: Category -> categories (schema: gadgetsonline_dbo) ---
            ...
            // --- PostgreSQL: Cart -> carts (schema: gadgetsonline_dbo) ---
            ...
            // --- PostgreSQL: Order -> orders (schema: gadgetsonline_dbo) ---
            ...
            // --- PostgreSQL: OrderDetail -> orderdetails (schema: gadgetsonline_dbo) ---
