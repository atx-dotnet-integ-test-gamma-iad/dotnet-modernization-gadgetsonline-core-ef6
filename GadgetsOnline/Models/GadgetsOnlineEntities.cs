...
namespace GadgetsOnline.Models
{
    ...
    // EF6 uses Npgsql when resolving the "name=GadgetsOnlineEntities" connection
    // string (or any explicit connection string) at runtime.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // database to carry DateTimeKind.Utc.  These overrides normalise any
        // Added/Modified entity values before they reach the database layer.
        // ---------------------------------------------------------------------------
