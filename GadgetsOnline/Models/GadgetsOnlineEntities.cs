...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Category entity — includes relationship + table/column mappings
            ...
            // Cart entity — includes relationship + table/column mappings
            ...
            // Order entity — includes relationship + table/column mappings
            ...
            // OrderDetail entity — includes relationship + table/column mappings
