...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // DateTime compatibility: ensure all DateTime values are sent to PostgreSQL
        // as UTC, matching Npgsql's strict timestamp handling.
        // ---------------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Column names are lowercase to match the PostgreSQL target schema.
            // -----------------------------------------------------------------------
