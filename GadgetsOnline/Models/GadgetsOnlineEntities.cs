...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // -------------------------------------------------------------------------
            // Category: table and column mappings + relationship configuration
            // -------------------------------------------------------------------------
            ...
            // -------------------------------------------------------------------------
            // Cart: table and column mappings + relationship configuration
            // -------------------------------------------------------------------------
            ...
            // -------------------------------------------------------------------------
            // Order: table and column mappings + relationship configuration
            // -------------------------------------------------------------------------
            ...
            // -------------------------------------------------------------------------
            // OrderDetail: table and column mappings + relationship configuration
            // -------------------------------------------------------------------------
