...
namespace GadgetsOnline.Models
{
    ...
    // Registers the Npgsql ADO.NET provider and connection factory so that EF6
    // resolves the correct services at runtime without requiring entries in
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        {
            // ------------------------------------------------------------------
            // Default schema: maps to the PostgreSQL target schema for this
            // database (gadgetsonline_dbo mirrors the original dbo schema).
            // ------------------------------------------------------------------
            modelBuilder.HasDefaultSchema("gadgetsonline_dbo");

            // ------------------------------------------------------------------
            // Table and column name mappings (PostgreSQL lowercase convention)
