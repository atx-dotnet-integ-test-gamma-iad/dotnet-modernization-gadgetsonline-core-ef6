...
namespace GadgetsOnline.Models
{
    ...
    // Required so that EF6 discovers and uses the Npgsql ADO.NET provider
    // instead of the default SQL Server provider at runtime.
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------------
        // DateTime UTC normalization for PostgreSQL (Npgsql requires UTC DateTimes)
        // ---------------------------------------------------------------------------
