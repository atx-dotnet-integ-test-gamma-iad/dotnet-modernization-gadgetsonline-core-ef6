...
namespace GadgetsOnline.Models
{
    ...
    // so that Entity Framework 6 routes all database operations through Npgsql.
    // -------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------
        // EF6 DateTime UTC fix: ensures all DateTime values are stored/read
        // with UTC kind, which Npgsql requires for timestamptz columns.
        // ---------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // -----------------------------------------------------------------
            {
                ...
                // Preserve: Category -> Products relationship
            ...
            // -----------------------------------------------------------------
            {
                ...
                // Preserve: Cart -> Product relationship
            ...
            // -----------------------------------------------------------------
            {
                ...
                // Preserve: Order -> OrderDetails relationship
            ...
            // -----------------------------------------------------------------
            {
                ...
                // Preserve: OrderDetail -> Product relationship
