...
namespace GadgetsOnline.Models
{
    ...
    /// Registers Npgsql services and connection factory so EF6 routes all
    /// database operations through the Npgsql ADO.NET driver.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // -------------------------------------------------------------------------
            // Category — table + column mappings, and relationship configuration
            // -------------------------------------------------------------------------
            ...
            // -------------------------------------------------------------------------
            // Cart — table + column mappings, and relationship configuration
            // -------------------------------------------------------------------------
            ...
            // -------------------------------------------------------------------------
            // Order — table + column mappings, and relationship configuration
            // -------------------------------------------------------------------------
            ...
            // -------------------------------------------------------------------------
            // OrderDetail — table + column mappings, and relationship configuration
            // -------------------------------------------------------------------------
        ...
        // -------------------------------------------------------------------------
        // EF6 DateTime UTC compatibility
        // Ensures all DateTime values written to PostgreSQL carry DateTimeKind.Utc,
        // preventing Npgsql "Cannot write DateTime with Kind=Local" exceptions.
        // -------------------------------------------------------------------------
