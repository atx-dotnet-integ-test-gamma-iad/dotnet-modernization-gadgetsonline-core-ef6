...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------
        // DateTime compatibility: ensure all DateTime values are stored as
        // UTC so Npgsql does not throw on "timestamp without time zone".
        // -----------------------------------------------------------------
        ...
        {
            // -----------------------------------------------------------------
            // Relationship configurations (preserved exactly from source)
            // -----------------------------------------------------------------
            ...
            // -----------------------------------------------------------------
            // PostgreSQL schema + lowercase column mappings
