...
namespace GadgetsOnline.Models
{
    ...
    // Registers Npgsql as the database provider services and connection factory
    // -------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // Ensures all DateTime values are stored with UTC kind, preventing
        // Npgsql's "Cannot write DateTime with Kind=Local" exceptions.
        // ---------------------------------------------------------------------
