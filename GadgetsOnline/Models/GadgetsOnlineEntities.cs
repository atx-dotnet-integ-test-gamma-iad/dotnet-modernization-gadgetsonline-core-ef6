...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // Npgsql requires DateTime values to have DateTimeKind.Utc when writing to
        // timestamptz columns. These overrides normalise any Unspecified/Local values
        // to Utc before they reach the database driver.
        // ---------------------------------------------------------------------------
