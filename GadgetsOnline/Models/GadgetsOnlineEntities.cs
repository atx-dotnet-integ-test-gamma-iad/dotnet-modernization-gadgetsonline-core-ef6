...
namespace GadgetsOnline.Models
{
    ...
    /// Registers Npgsql services and connection factory so that EF6 uses
    /// the PostgreSQL provider instead of SQL Server.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------
        // DateTime UTC fix: Npgsql requires all DateTime values stored in
        // timestamptz columns to carry DateTimeKind.Utc.  These overrides
        // normalise every Added/Modified DateTime to Utc before the write
        // reaches the database, matching legacy MSSQL "unspecified" behaviour.
        // ---------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Column names are lowercase to match the PostgreSQL migrated schema.
            // ------------------------------------------------------------------
