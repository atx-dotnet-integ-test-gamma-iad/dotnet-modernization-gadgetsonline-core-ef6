...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // Npgsql requires DateTime values to have Kind = Utc when writing to
        // timestamptz columns. These overrides normalise all DateTime values
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // OrderDetail requires one Product
            modelBuilder.Entity<OrderDetail>()
