...
{
    // ---------------------------------------------------------------------------
    // PostgreSQL DbConfiguration — registers the Npgsql provider for EF6.
    // Must be in the same assembly as the DbContext.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // on Add/Modified entries before delegating to the base implementation.
        // ---------------------------------------------------------------------------
