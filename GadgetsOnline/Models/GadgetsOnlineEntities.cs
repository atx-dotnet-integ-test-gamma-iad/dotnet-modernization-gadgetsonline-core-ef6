...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // ---------------------------------------------------------------------------
            // Category — table & column mappings + relationship to Products
            // ---------------------------------------------------------------------------
            ...
            // ---------------------------------------------------------------------------
            // Cart — table & column mappings + relationship to Product
            // ---------------------------------------------------------------------------
            ...
            // ---------------------------------------------------------------------------
            // Order — table & column mappings + relationship to OrderDetails
            // ---------------------------------------------------------------------------
            ...
            // ---------------------------------------------------------------------------
            // OrderDetail — table & column mappings + relationship to Product
            // ---------------------------------------------------------------------------
