...
namespace GadgetsOnline.Models
{
    ...
    // that EF6 routes all database operations through Npgsql instead of SqlClient.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // Npgsql requires all DateTime values sent to PostgreSQL timestamptz
        // columns to be explicitly marked as UTC (DateTimeKind.Utc). These
        // overrides ensure any Added/Modified entity with a DateTime property
        // has its Kind set to Utc before the values reach the driver.
        // -----------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Relationship: Category HasMany Products (preserved)
            // -------------------------------------------------------------------
            ...
            // Relationship: Cart HasRequired Product (preserved)
            // -------------------------------------------------------------------
            ...
            // Relationship: Order HasMany OrderDetails (preserved)
            // -------------------------------------------------------------------
            ...
            // Relationship: OrderDetail HasRequired Product (preserved)
            // -------------------------------------------------------------------
