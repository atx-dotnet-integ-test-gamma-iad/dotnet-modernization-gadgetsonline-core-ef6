...
namespace GadgetsOnline.Models
{
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        {
            // -----------------------------------------------------------------------
            // Schema + column mappings: Product -> gadgetsonline_dbo.products
            // -----------------------------------------------------------------------
            ...
            // -----------------------------------------------------------------------
            // Schema + column mappings: Category -> gadgetsonline_dbo.categories
            // -----------------------------------------------------------------------
            ...
            // -----------------------------------------------------------------------
            // Schema + column mappings: Cart -> gadgetsonline_dbo.carts
            // -----------------------------------------------------------------------
            ...
            // -----------------------------------------------------------------------
            // Schema + column mappings: Order -> gadgetsonline_dbo.orders
            // -----------------------------------------------------------------------
            ...
            // -----------------------------------------------------------------------
            // Schema + column mappings: OrderDetail -> gadgetsonline_dbo.orderdetails
            // -----------------------------------------------------------------------
