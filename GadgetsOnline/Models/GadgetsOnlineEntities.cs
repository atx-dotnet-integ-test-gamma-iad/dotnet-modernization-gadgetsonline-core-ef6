...
{
    /// <summary>
    /// EF6 PostgreSQL DbConfiguration — registers the Npgsql provider
    /// and sets it as the default connection factory.
    /// </summary>
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        {
            // -------------------------------------------------------
            // Table & column mappings — PostgreSQL schema: gadgetsonline_dbo
            // -------------------------------------------------------
