...
namespace GadgetsOnline.Models
{
    ...
    // EF6 can resolve the provider without relying on machine-level config.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        {
            // ---------------------------------------------------------------
            // Table-to-schema mappings  (dbo  ->  gadgetsonline_dbo)
            // ---------------------------------------------------------------
        ...
        // Npgsql rejects DateTime values whose Kind is not Utc when the
        // column type is 'timestamp with time zone'.  The helpers below
        // coerce every tracked DateTime to DateTimeKind.Utc before the
