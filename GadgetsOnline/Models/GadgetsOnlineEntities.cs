...
namespace GadgetsOnline.Models
{
    ...
    // EF6 can resolve the correct ADO.NET driver when the app-config provider
    // entry is "Npgsql".
    // -------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // ---------------------------------------------------------------------
        // DateTime UTC compatibility – EF6 PostgreSQL requires all DateTime
        // values written to the database to carry DateTimeKind.Utc.
        // ---------------------------------------------------------------------
        ...
        {
            // -----------------------------------------------------------------
            // Entity: Product  →  gadgetsonline_dbo.products
            // -----------------------------------------------------------------
            ...
            // -----------------------------------------------------------------
            // Entity: Category  →  gadgetsonline_dbo.categories
            // -----------------------------------------------------------------
            ...
            // -----------------------------------------------------------------
            // Entity: Cart  →  gadgetsonline_dbo.carts
            // -----------------------------------------------------------------
            ...
            // -----------------------------------------------------------------
            // Entity: Order  →  gadgetsonline_dbo.orders
            // -----------------------------------------------------------------
            ...
            // -----------------------------------------------------------------
            // Entity: OrderDetail  →  gadgetsonline_dbo.orderdetails
            // -----------------------------------------------------------------
