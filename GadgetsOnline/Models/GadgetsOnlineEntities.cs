...
namespace GadgetsOnline.Models
{
    ...
    // the "name=GadgetsOnlineEntities" connection-string entry in Web.config
    // continues to work without any code changes to callers.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // PostgreSQL timestamptz columns to carry DateTimeKind.Utc.  The
        // helpers below normalise every DateTime on Add/Modify so existing
        // code that supplies unspecified/local DateTimes continues to work.
        // ------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // All names are lowercased to match the PostgreSQL target database.
            // ----------------------------------------------------------------
