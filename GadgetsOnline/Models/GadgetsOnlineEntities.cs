...
namespace GadgetsOnline.Models
{
    ...
    // factory without relying on app.config / web.config provider registration.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // -----------------------------------------------------------------------
        // DateTime UTC fix: ensures DateTime values stored with correct Kind so
        // Npgsql does not throw on timestamptz round-trip.
        // -----------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Generated from Fluent API analysis — source of truth is tool output.
            // -------------------------------------------------------------------
