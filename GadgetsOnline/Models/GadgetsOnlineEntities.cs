...
namespace GadgetsOnline.Models
{
    ...
    // Registered via [DbConfigurationType] attribute on GadgetsOnlineEntities so
    // that EntityFramework6.Npgsql picks up the correct provider services and
    // connection factory without requiring an App.config <entityFramework> entry.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // before they are written to PostgreSQL (which is UTC-strict).
        // -----------------------------------------------------------------
