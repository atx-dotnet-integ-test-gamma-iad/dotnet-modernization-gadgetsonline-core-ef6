...
namespace GadgetsOnline.Models
{
    ...
    // EntityFramework6.Npgsql is used instead of SQL Server.
    // ---------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // database to carry DateTimeKind.Utc.  These overrides normalise every
        // Added/Modified entity before hitting the database so that existing
        // code that creates plain (Unspecified/Local) DateTime values continues
