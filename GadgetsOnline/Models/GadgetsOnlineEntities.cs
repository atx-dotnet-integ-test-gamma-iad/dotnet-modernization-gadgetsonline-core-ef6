...
namespace GadgetsOnline.Models
{
    ...
    // EF6 can resolve the driver without an App.config <provider> entry.
    // -------------------------------------------------------------------------
    ...
    public class GadgetsOnlineEntities : DbContext
    {
        ...
        // PostgreSQL requires all DateTime values to carry DateTimeKind.Utc.
        // These overrides normalise every tracked DateTime on save.
        // ---------------------------------------------------------------------
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Column names   : lowercase (source of truth: schema mapping tool)
            // -----------------------------------------------------------------
